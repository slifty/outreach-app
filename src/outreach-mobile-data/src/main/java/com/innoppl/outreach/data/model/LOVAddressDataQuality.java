...
@Cacheable
@Entity
@Table(name = "PATH_CODE_ADDRESS_TYPE")
public class LOVAddressDataQuality extends LOV {
    ...
    public Integer getLovType() {
        return 8; // TODO: This is terrible -- this should come from a central list somewhere.
    }
